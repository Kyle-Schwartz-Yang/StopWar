...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_functional_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/functional.js */ \"./source/javascript/modules/functional.js\");\n/* harmony import */ var _modules_countdown_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/countdown.js */ \"./source/javascript/modules/countdown.js\");\n/* harmony import */ var _modules_header_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/header.js */ \"./source/javascript/modules/header.js\");\n/* harmony import */ var _mode_sliders_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./mode/sliders.js */ \"./source/javascript/mode/sliders.js\");\n\n_modules_functional_js__WEBPACK_IMPORTED_MODULE_0__.isWebp();\n\n//------------------------------------------------------------\n//! Установить таймер:\n\nsetInterval(_modules_countdown_js__WEBPACK_IMPORTED_MODULE_1__.updateCounter, 1000);\n_modules_countdown_js__WEBPACK_IMPORTED_MODULE_1__.initCountdown();\n//------------------------------------------------------------------\n\n//------------------------------------------------------------------\n\n(0,_modules_header_js__WEBPACK_IMPORTED_MODULE_2__.initBurger)();\n\n// const burger = document.querySelector('.burger');\n// const menuBody = document.querySelector('.header__body');\n\n// burger.addEventListener('click', (e) => {\n//   burger.classList.toggle('open');\n//   menuBody.classList.toggle('open');\n// })\n\n//------------------------------------------------------------------\n//SWIPER\n//-------------------------------------------------------------------\n\n(0,_mode_sliders_js__WEBPACK_IMPORTED_MODULE_3__.initialSwiperSpeaker)('.speaker__swiper');\n(0,_mode_sliders_js__WEBPACK_IMPORTED_MODULE_3__.initialSwiperSponsors)('.sponsors__swiper');\n\n//# sourceURL=webpack://mc-truth-palace/./source/javascript/app.js?");

/***/ }),

/***/ "./source/javascript/mode/sliders.js":
/*!*******************************************!*\
  !*** ./source/javascript/mode/sliders.js ***!
  \*******************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   initialSwiperSpeaker: () => (/* binding */ initialSwiperSpeaker),\n/* harmony export */   initialSwiperSponsors: () => (/* binding */ initialSwiperSponsors)\n/* harmony export */ });\n/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! swiper */ \"./node_modules/swiper/swiper.mjs\");\n/* harmony import */ var swiper_modules__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! swiper/modules */ \"./node_modules/swiper/modules/index.mjs\");\n\n\n// '.speaker__swiper'\n\nfunction initialSwiperSpeaker(selector) {\n  return new swiper__WEBPACK_IMPORTED_MODULE_0__[\"default\"](selector, {\n    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Keyboard, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.EffectCards, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Autoplay],\n    direction: 'horizontal',\n    loop: true,\n    autoHeight: false,\n    grabCursor: true,\n    slidesPerView: 1,\n    spaceBetween: 0,\n    speed: 700,\n    // autoplay: { delay: 5000 },\n    keyboard: {\n      enabled: true\n    },\n    navigation: {\n      nextEl: \".speaker__button-next\",\n      prevEl: \".speaker__button-prev\"\n    },\n    // Используем брейкпоинты Swiper\n    breakpoints: {\n      // Когда ширина экрана >= 992px\n      992: {\n        // Отключаем Swiper\n        enabled: false\n      }\n    }\n  });\n}\nfunction initialSwiperSponsors(selector) {\n  return new swiper__WEBPACK_IMPORTED_MODULE_0__[\"default\"](selector, {\n    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Keyboard, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.EffectCards],\n    direction: 'horizontal',\n    loop: true,\n    autoHeight: false,\n    grabCursor: true,\n    slidesPerView: 1,\n    spaceBetween: 100,\n    speed: 700,\n    // autoplay: { delay: 5000 },\n\n    keyboard: {\n      enabled: true\n    },\n    pagination: {\n      el: \".sponsors__pagination\",\n      clickable: true\n    }\n  });\n}\n\n//# sourceURL=webpack://mc-truth-palace/./source/javascript/mode/sliders.js?");

/***/ }),

/***/ "./source/javascript/modules/countdown.js":
/*!************************************************!*\
  !*** ./source/javascript/modules/countdown.js ***!
  \************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   initCountdown: () => (/* binding */ initCountdown),\n/* harmony export */   updateCounter: () => (/* binding */ updateCounter)\n/* harmony export */ });\n// Действующие элементы: \nvar days = document.querySelector('#days');\nvar hours = document.querySelector('#hours');\nvar minutes = document.querySelector('#minutes');\n// Получить 10д. 12ч. 36хв.\nvar countDownDate = new Date().getTime() + 10 * 24 * 60 * 60 * 1000 + 12 * 60 * 60 * 1000 + 36 * 60 * 1000;\nfunction updateCounter() {\n  var now = new Date().getTime();\n  var distance = countDownDate - now;\n\n  //--------------------------------------------------------\n  // Осталось: Дней, Часов, Минут\n  var daysLeft = Math.floor(distance / 1000 / 60 / 60 / 24); // 255\n  var hoursLeft = Math.floor(distance / 1000 / 60 / 60) % 24;\n  var minutesLeft = Math.floor(distance / 1000 / 60) % 60;\n  // -------------------------------------------------------------------------\n  // ! Заполнение таймера: \n  // Если нам нужена всегда двойное число : ( 08, 09, 01, 03, итд. )\n  days.innerText = daysLeft < 10 ? \"0\".concat(daysLeft) : daysLeft;\n  hours.innerText = hoursLeft < 10 ? \"0\".concat(hoursLeft) : hoursLeft;\n  minutes.innerText = minutesLeft < 10 ? \"0\".concat(minutesLeft) : minutesLeft;\n\n  // Если отсчет закончился, останавливаем таймер\n  if (distance < 0) {\n    clearInterval(updateCounter);\n    document.getElementById(\"countdown\").innerHTML = \"ВРЕМЯ ВЫШЛО\";\n  }\n  // -------------------------------------------------------------------------\n}\n\n// -----------------------------------------------------------------\n//! Убрать loading спустя 1 секунду\nfunction initCountdown() {\n  setTimeout(function () {\n    var preloader = document.querySelector('.countdown__preloader');\n    var countdownTime = document.querySelectorAll('.countdown__time');\n    preloader.remove();\n    // countdownTime.forEach((time, index) => setTimeout(() => time.style.visibility = 'visible', 300 * index));\n    countdownTime.forEach(function (time) {\n      return time.style.visibility = 'visible';\n    });\n  }, 1000);\n}\n\n\n//# sourceURL=webpack://mc-truth-palace/./source/javascript/modules/countdown.js?");

/***/ }),

/***/ "./source/javascript/modules/functional.js":
/*!*************************************************!*\
  !*** ./source/javascript/modules/functional.js ***!
  \*************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   isWebp: () => (/* binding */ isWebp)\n/* harmony export */ });\n//Functional + Templates\n\n//*FUNCTIONAL\n//$================================================================================\n/* Перевірка підтримки webp, додавання класу webp або no-webp для <html> */\n/* (i) необхідно для коректного відображення webp із css */\nfunction isWebp() {\n  //--------------------------------------\n  function testWebP(callback) {\n    var webP = new Image();\n    webP.onload = webP.onerror = function () {\n      callback(webP.height == 2);\n    };\n    // Путь к пустому изображению WebP в кодировке base64\n    webP.src = 'data:image/webp;base64,UklGRi4AAABXRUJQVlA4ICIAAABQAQCdASoDAAIAAgA2JQBOgC6gAP73M8eLuxHGTv3eIAAA';\n  }\n  //--------------------------------------\n  testWebP(function (support) {\n    var className = support === true ? 'webp' : \"no-webp\";\n    document.documentElement.classList.add(className);\n  });\n  //--------------------------------------\n}\n//$================================================================================\n\n//# sourceURL=webpack://mc-truth-palace/./source/javascript/modules/functional.js?");

/***/ }),

/***/ "./source/javascript/modules/header.js":
/*!*********************************************!*\
  !*** ./source/javascript/modules/header.js ***!
  \*********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   initBurger: () => (/* binding */ initBurger)\n/* harmony export */ });\nfunction initBurger() {\n  var burger = document.querySelector('.burger');\n  var menuBody = document.querySelector('.header__body');\n  var bodyElement = document.body;\n  if (burger && menuBody) {\n    burger.addEventListener('click', toggleBurger);\n  }\n  function toggleBurger() {\n    burger.classList.toggle('open');\n    menuBody.classList.toggle('open');\n    bodyElement.classList.toggle('no-scroll');\n  }\n}\n\n//# sourceURL=webpack://mc-truth-palace/./source/javascript/modules/header.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   c: () => (/* binding */ classesToSelector)\n/* harmony export */ });\nfunction classesToSelector(classes) {\n  if (classes === void 0) {\n    classes = '';\n  }\n  return `.${classes.trim().replace(/([\\.:!+\\/])/g, '\\\\$1') // eslint-disable-line\n  .replace(/ /g, '.')}`;\n}\n\n\n\n\n//# sourceURL=webpack://mc-truth-palace/./node_modules/swiper/shared/classes-to-selector.mjs?");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./source/javascript/app.js");
/******/ 	
/******/ })()
;